...
// Real iTunes podcast IDs — used for the iTunes Lookup API.
// Verify at: https://itunes.apple.com/lookup?id=<ID>&entity=podcastEpisode&limit=1
export const SEED_PODCASTS: Podcast[] = [
  ...
  },
  {
    ...
    description: 'Industry veterans discuss tech, finance, and politics.',
  ...
  // History
  {
    ...
    author: 'Dan Carlin',
    description: 'Dan Carlin applies his "Martian" perspective to the past.',
  ...
  // Society & Education
  {
    ...
    description: "If you've ever wanted to know about champagne, satanism, chaos theory, etc.",
  ...
  // Sports
  {
    ...
    author: 'The Ringer',
    description: "The Ringer's Bill Simmons talks NFL, NBA, and pop culture.",
  ...
  // Arts
  {
    ...
    description: 'Musicians take apart their songs and discuss how they were made.',
